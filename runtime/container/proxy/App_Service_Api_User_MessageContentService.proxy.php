 ...
 */
class MessageContentService implements ApiServiceInterface
{
    ...
    {
        return $this->messageRepository->repositorySelect(self::searchWhere((array) $requestParams), (int) $requestParams['size'] ?? 20);
    }
    /**
     * 创建数据
     *
    ...
    {
        (new MessageHistoryService())->serviceCreate((array) ['platform_message_content_uuid' => $requestParams['uuid']]);
