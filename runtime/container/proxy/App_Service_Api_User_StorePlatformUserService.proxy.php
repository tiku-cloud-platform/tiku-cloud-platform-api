...
use App\Repository\Api\User\StorePlatformApiRepository;
 ...
 */
class StorePlatformUserService implements ApiServiceInterface
{
    ...
    /**
     * @Inject()
     * @var StorePlatformApiRepository
     */
    ...
    {
        $updateWhere = [['uuid', '=', $requestParams['uuid']]];
