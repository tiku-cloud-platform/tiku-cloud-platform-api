...
import (
	...
	"tiku-cloud/app/service/users/token_cache_redis"
	"tiku-cloud/app/utils/md5_encrypt"
)
...
// SetTokenInvalid 禁用一个用户的: 1.tb_users表的 status 设置为 0，tb_oauth_access_tokens 表的所有token删除
