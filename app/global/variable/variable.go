...
import (
	...
	"tiku-cloud/app/utils/snow_flake/snowflake_interf"
	"tiku-cloud/app/utils/yml_config/ymlconfig_interf"
)

// tiku-cloud 封装的全局变量全部支持并发安全，请放心使用即可
