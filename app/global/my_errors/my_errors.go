...
const (
	// ErrorsContainerKeyAlreadyExists 系统部分
	...
	// ErrorsRedisInitConnFail redis部分
	...
	// ErrorsValidatorNotExists 表单参数验证器未通过时的错误
