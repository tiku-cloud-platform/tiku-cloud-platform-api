...
import (
	...
	_ "tiku-cloud/app/core/destroy" // 监听程序退出信号，用于资源的释放
	"tiku-cloud/app/global/my_errors"
	"tiku-cloud/app/global/variable"
	"tiku-cloud/app/http/validator/common/register_validator"
	"tiku-cloud/app/service/sys_log_hook"
	"tiku-cloud/app/utils/casbin_v2"
	"tiku-cloud/app/utils/gorm_v2"
	"tiku-cloud/app/utils/snow_flake"
	"tiku-cloud/app/utils/validator_translation"
	"tiku-cloud/app/utils/websocket/core"
	"tiku-cloud/app/utils/yml_config"
	"tiku-cloud/app/utils/zap_factory"
)
